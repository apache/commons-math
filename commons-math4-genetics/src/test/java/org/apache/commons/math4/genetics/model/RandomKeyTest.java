...
public class RandomKeyTest {
    ...
    public void testConstructor1() {
        new RandomKey<>(new Double[] {0.2, 0.3, 1.2}, chromosome -> {
            return 0;
        });
    }
    ...
    public void testConstructor2() {
        new RandomKey<>(new Double[] {0.2, 0.3, -0.2}, chromosome -> {
            return 0;
        });
    }
    ...
    public void testIsSame() {
        RandomKey<?> drk1 = new RandomKey<>(new Double[] {0.4, 0.1, 0.5, 0.8, 0.2}, chromosome -> {
            return 0;
        });
        RandomKey<?> drk2 = new RandomKey<>(new Double[] {0.4, 0.1, 0.5, 0.8, 0.2}, chromosome -> {
            return 0;
        });
        RandomKey<?> drk3 = new RandomKey<>(new Double[] {0.4, 0.15, 0.5, 0.8, 0.2}, chromosome -> {
            return 0;
        });
        RandomKey<?> drk4 = new RandomKey<>(new Double[] {0.4, 0.25, 0.5, 0.8, 0.2}, chromosome -> {
            return 0;
        });
        RandomKey<?> drk5 = new RandomKey<>(new Double[] {0.4, 0.25, 0.5, 0.8, 0.2, 0.5}, chromosome -> {
            return 0;
        });
    ...
    public void testDecode() {
        RandomKey<String> drk = new RandomKey<>(new Double[] {0.4, 0.1, 0.5, 0.8, 0.2}, chromosome -> {
            return 0;
        });
    ...
    public void testInvalidRepresentation() {
        new RandomKey<>(new Double[] {0.1, 0.1, 2d, 0.8, 0.2}, chromosome -> {
            return 0;
        });
    }
    ...
    public void testRandomPermutation() {
        ...
        for (int i = 0; i < 10; i++) {
            RandomKey<?> drk = RandomKey.randomChromosome(20, chromosome -> {
                return 0;
            });
    ...
    public void testIdentityPermutation() {
        RandomKey<String> drk = new RandomKey<>(RandomKey.identityPermutation(5), chromosome -> {
            return 0;
        });
        List<String> decoded = drk.decode(Arrays.asList(new String[] {"a", "b", "c", "d", "e"}));
    ...
    public void testComparatorPermutation() {
        ...
        List<String> decodedData = new RandomKey<String>(permutation, chromosome -> {
            return 0;
        }).decode(data);
        ...
        decodedData = new RandomKey<String>(permutation, chromosome -> {
            return 0;
        }).decode(data);
    ...
    public void testInducedPermutation() {
        ...
        RandomKey<String> drk = new RandomKey<>(RandomKey.inducedPermutation(origData, permutedData), chromosome -> {
            return 0;
        });
    ...
    public void testEqualRepr() {
        RandomKey<String> drk = new RandomKey<>(new Double[] {0.2, 0.2, 0.5}, chromosome -> {
            return 0;
        });
