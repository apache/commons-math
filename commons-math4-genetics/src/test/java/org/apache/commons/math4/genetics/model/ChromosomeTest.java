...
public class ChromosomeTest {
    ...
    public void testCompareTo() {
        Chromosome c1 = new Chromosome(chromosome -> {
            return 0;
        }) {
        };
        Chromosome c2 = new Chromosome(chromosome -> {
            return 10;
        }) {
        };
        Chromosome c3 = new Chromosome(chromosome -> {
            return 10;
        }) {
        };
    ...
    public void testFindSameChromosome() {
        ...
        DummyChromosome c1 = new DummyChromosome(1, chromosome -> {
            return 1;
        }) {
        };
        DummyChromosome c2 = new DummyChromosome(2, chromosome -> {
            return 2;
        }) {
        };
        DummyChromosome c3 = new DummyChromosome(3, chromosome -> {
            return 3;
        }) {
        };
        DummyChromosome c4 = new DummyChromosome(1, chromosome -> {
            return 5;
        }) {
        };
        DummyChromosome c5 = new DummyChromosome(15, chromosome -> {
            return 15;
        }) {
        };
