...
public class OnePointCrossoverTest {
    ...
    public void testCrossover() {
        ...
        BinaryChromosome p1c = new BinaryChromosome(p1, chromosome -> {
            return 0;
        });
        BinaryChromosome p2c = new BinaryChromosome(p2, chromosome -> {
            return 0;
        });
        ...
        for (int i = 0; i < 20; i++) {
            ChromosomePair pair = opc.crossover(p1c, p2c, 1.0);
