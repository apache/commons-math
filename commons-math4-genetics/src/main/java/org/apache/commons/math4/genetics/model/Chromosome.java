...
public abstract class Chromosome implements Comparable<Chromosome>, Fitness {
	 ...
	 * @return Chromosome with the same representation, or <code>null</code> if no
	 *         such chromosome exists.
	 */
	...
	/**
	 * Searches the population for a chromosome representing the same solution, and
	 * if it finds one, updates the fitness to its value.
	 *
	 * @param population Population to search
	 */
