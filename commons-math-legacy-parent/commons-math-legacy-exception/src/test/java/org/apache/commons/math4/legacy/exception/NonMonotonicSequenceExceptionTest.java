...
public class NonMonotonicSequenceExceptionTest {
    ...
    public void testAccessors() {
        NonMonotonicSequenceException e
            = new NonMonotonicSequenceException(0, -1, 1,
        ...
        Assert.assertTrue(
        e.getDirection() == /*TODO remove after creation of util see  MATH-1575 */OrderDirection.DECREASING
        );
        ...
        Assert.assertEquals(1, e.getIndex());
        Assert.assertTrue(
        e.getDirection() == /*TODO remove after creation of util see  MATH-1575 */OrderDirection.INCREASING
        );
