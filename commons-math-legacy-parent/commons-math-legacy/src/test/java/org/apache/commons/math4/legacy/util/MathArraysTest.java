...
import org.apache.commons.math4.legacy.exception.OrderDirection;
...
public class MathArraysTest {
    ...
    public void testCheckOrder() {
        MathArrays.checkOrder(new double[] {-15, -5.5, -1, 2, 15},
                /*TODO remove after creation of util see  MATH-1575 */OrderDirection.INCREASING, true);
        MathArrays.checkOrder(new double[] {-15, -5.5, -1, 2, 2},
                /*TODO remove after creation of util see  MATH-1575 */OrderDirection.INCREASING, false);
        MathArrays.checkOrder(new double[] {3, -5.5, -11, -27.5},
                /*TODO remove after creation of util see  MATH-1575 */OrderDirection.DECREASING, true);
        MathArrays.checkOrder(new double[] {3, 0, 0, -5.5, -11, -27.5},
                /*TODO remove after creation of util see  MATH-1575 */OrderDirection.DECREASING, false);
    ...
    public void testSortInPlaceDecreasingOrder() {
        ...
        MathArrays.sortInPlace(x1,
                               /*TODO remove after creation of util see  MATH-1575 */OrderDirection.DECREASING,
                               x2, x3);
