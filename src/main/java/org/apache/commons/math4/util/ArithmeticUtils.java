...
public final class ArithmeticUtils {
	...
	public static int lcm(int a, int b) throws MathArithmeticException {
		...
		int lcm = FastMath.abs(ArithmeticUtils.mulAndCheck(a
				/ gcd(a, b), b));
	...
	public static long lcm(long a, long b) throws MathArithmeticException {
		...
		long lcm = FastMath.abs(ArithmeticUtils.mulAndCheck(a
				/ gcd(a, b), b));
	 ...
	 * @return the sum {@code a + b}.
	 * @throws MathArithmeticException
	 *             if the result cannot be represented as a {@code long}.
	 * @since 1.2
	 */
	 ...
	 * value.
	 * <p>
	 * This method doesn't use long datatype unlike it's used in
	 ...
	 * value.
	 * <p>
	 * This method doesn't use BigInteger datatype unlike it's used in
