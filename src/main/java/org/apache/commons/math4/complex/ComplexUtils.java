...
public class ComplexUtils {
    ...
    /** Initialize an one-dimension array of complex with {@link Complex#ZERO}.
     * @param c array to initialize
     * @return the initialized array, in fluent-style API
     * @since 4.0
     */
    ...
    /** Initialize an two-dimension array of complex with {@link Complex#ZERO}.
     * @param c array to initialize
     * @return the initialized array, in fluent-style API
     * @since 4.0
     */
    ...
    /** Initialize an three-dimension array of complex with {@link Complex#ZERO}.
     * @param c array to initialize
     * @return the initialized array, in fluent-style API
     * @since 4.0
     */
