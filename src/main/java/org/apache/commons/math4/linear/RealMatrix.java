...
public interface RealMatrix extends AnyMatrix {
	 ...
	 *             Of type {@code NOT_STRICTLY_POSITIVE} if row or column
	 *             dimension is not positive.
	 */
	RealMatrix createMatrix(int rowDimension, int columnDimension) throws MathException;
	 ...
	 *             if {@code m} is not the same size as {@code this}.
	 */
	RealMatrix add(RealMatrix m) throws MathException;
	 ...
	 * @throws OutOfRangeException
	 *             if {@code subMatrix} does not fit into this matrix from
	 *             element in {@code (row, column)}.
	 * @throws DimensionMismatchException
	 *             if {@code subMatrix} is not rectangular (not all rows have
	 ...
	 *            Row to be set.
	 * @param matrix
	 *            Row matrix to be copied (must have one row and the same number
	 *            of columns as the instance).
	 * @throws OutOfRangeException
	 *             if the specified row index is invalid.
	 * @throws MatrixDimensionMismatchException
	 *             if the row dimension of the {@code matrix} is not {@code 1},
	 *             or the column dimensions of {@code this} and {@code matrix}
	 *             do not match.
	 */
	 ...
	 *            Column to be set.
	 * @param matrix
	 *            Column matrix to be copied (must have one column and the same
	 *            number of rows as the instance).
	 * @throws OutOfRangeException
	 *             if the specified column index is invalid.
	 * @throws MatrixDimensionMismatchException
	 *             if the column dimension of the {@code matrix} is not
	 *             {@code 1}, or the row dimensions of {@code this} and
	 *             {@code matrix} do not match.
	 */
	 ...
	 *            Row to be set.
	 * @param vector
	 *            row vector to be copied (must have the same number of column
	 *            as the instance).
	 * @throws OutOfRangeException
	 *             if the specified row index is invalid.
	 * @throws MatrixDimensionMismatchException
	 *             if the {@code vector} dimension does not match the column
	 ...
	 *            Column to be set.
	 * @param vector
	 *            column vector to be copied (must have the same number of rows
	 *            as the instance).
	 * @throws OutOfRangeException
	 *             if the specified column index is invalid.
	 * @throws MatrixDimensionMismatchException
	 *             if the {@code vector} dimension does not match the row
	 *             dimension of {@code this} matrix.
	 */
	...
	/**
	 * Sets the specified {@code row} of {@code this} matrix to the entries of
	 * the specified {@code array}. Row indices start at 0.
	 *
	 * @param row
	 *            Row to be set.
	 * @param array
	 *            Row matrix to be copied (must have the same number of columns
	 *            as the instance)
	 * @throws OutOfRangeException
	 *             if the specified row index is invalid.
	 * @throws MatrixDimensionMismatchException
	 *             if the {@code array} length does not match the column
	 *             dimension of {@code this} matrix.
	 */
	 ...
	 *             if the specified column index is invalid.
	 * @throws MatrixDimensionMismatchException
	 *             if the {@code array} length does not match the row dimension
	 *             of {@code this} matrix.
	 */
	...
	/**
	 * Returns the
	 * <a href="http://mathworld.wolfram.com/MatrixTrace.html"> trace</a> of the
	 * matrix (the sum of the elements on the main diagonal).
	 *
	 * @return the trace.
	 * @throws NonSquareMatrixException
	 *             if the matrix is not square.
	 ...
	 * @return {@code this * v}
	 * @throws DimensionMismatchException
	 *             if the length of {@code v} does not match the column
	 ...
	 * @return {@code this * v}
	 * @throws DimensionMismatchException
	 *             if the dimension of {@code v} does not match the column
	 *             dimension of {@code this}.
	 */
	 ...
	 * @return {@code v * this}
	 * @throws DimensionMismatchException
	 *             if the length of {@code v} does not match the row dimension
	 *             of {@code this}.
	 */
	 ...
	 * @return {@code v * this}
	 * @throws DimensionMismatchException
	 *             if the dimension of {@code v} does not match the row
	 *             dimension of {@code this}.
	 */
	 ...
	 * @see #walkInOptimizedOrder(RealMatrixPreservingVisitor, int, int, int,
	 *      int)
	 * @return the value returned by {@link RealMatrixChangingVisitor#end()} at
	 *         the end of the walk
	 */
	 ...
	 * @see #walkInOptimizedOrder(RealMatrixPreservingVisitor, int, int, int,
	 *      int)
	 * @return the value returned by {@link RealMatrixPreservingVisitor#end()}
	 ...
	 *         the end of the walk
	 */
	double walkInRowOrder(RealMatrixChangingVisitor visitor, int startRow, int endRow, int startColumn,
	 ...
	 *         at the end of the walk
	 */
	double walkInRowOrder(RealMatrixPreservingVisitor visitor, int startRow, int endRow, int startColumn,
			int endColumn) throws OutOfRangeException, NumberIsTooSmallException;
	 ...
	 *         the end of the walk
	 */
	double walkInColumnOrder(RealMatrixChangingVisitor visitor, int startRow, int endRow, int startColumn,
			int endColumn) throws OutOfRangeException, NumberIsTooSmallException;
	 ...
	 *         at the end of the walk
	 */
	double walkInColumnOrder(RealMatrixPreservingVisitor visitor, int startRow, int endRow, int startColumn,
			int endColumn) throws OutOfRangeException, NumberIsTooSmallException;
	 ...
	 *         the end of the walk
	 */
	double walkInOptimizedOrder(RealMatrixChangingVisitor visitor, int startRow, int endRow, int startColumn,
			int endColumn) throws OutOfRangeException, NumberIsTooSmallException;
	...
	double walkInOptimizedOrder(RealMatrixPreservingVisitor visitor, int startRow, int endRow,
			int startColumn, int endColumn) throws OutOfRangeException, NumberIsTooSmallException;
}
