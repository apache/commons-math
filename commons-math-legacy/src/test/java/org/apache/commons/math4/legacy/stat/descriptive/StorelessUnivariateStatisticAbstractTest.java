...
public abstract class StorelessUnivariateStatisticAbstractTest
    ...
    public void testEqualsAndHashCode() {
        ...
        Assert.assertFalse("non-empty, compared to empty", statistic.equals(statistic2));
        Assert.assertFalse("non-empty, compared to empty", statistic2.equals(statistic));
        ...
        Assert.assertFalse("stats with different n's should not be equal", statistic2.equals(statistic));
