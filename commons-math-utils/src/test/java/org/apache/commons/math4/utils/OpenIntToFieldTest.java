...
import org.apache.commons.math4.utils.OpenIntToFieldHashMap;
import org.apache.commons.math4.utils.dfp.Dfp;
import org.apache.commons.math4.utils.dfp.DfpField;
import org.apache.commons.math4.utils.dfp.Dfp25;
...
public class OpenIntToFieldTest {
    ...
    public void testPutAbsentOnExisting() {
        ...
        for (Entry<Integer, Dfp> mapEntry : generateAbsent().entrySet()) {
            map.put(mapEntry.getKey(), mapEntry.getValue());
    ...
    public void testGetAbsent() {
        ...
        for (Entry<Integer, Dfp> mapEntry : generated.entrySet()) {
