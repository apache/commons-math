...
import org.apache.commons.math4.utils.DoubleArray;
...
public abstract class DoubleArrayAbstractTest {
    ...
    public void testAddElementRolling() {
        ...
        Assert.assertEquals(
            ...
            2.0,
            TestUtils.max(ra.getElements()),
            Double.MIN_VALUE);
        Assert.assertEquals(
            "The min element should be 1.0",
            1.0,
            TestUtils.min(ra.getElements()),
            Double.MIN_VALUE);
    ...
    public void testMinMax() {
        ...
        Assert.assertEquals("Min should be -2.0", -2.0, TestUtils.min(da.getElements()), Double.MIN_VALUE);
        Assert.assertEquals(
            "Max should be 1212.0",
            1212.0,
            TestUtils.max(da.getElements()),
            Double.MIN_VALUE);
    }
