...
public class StableRandomGeneratorTest {
    ...
    public void testNextDouble() {
        ...
        Assert.assertEquals(0.0, TestUtils.mean(sample), 0.3);
    }
    ...
    public void testGaussianCase() {
        ...
        Assert.assertEquals(0.0, TestUtils.mean(sample), 0.02);
        Assert.assertEquals(1.0, TestUtils.variance(sample), 0.02);
    }

    /**
     * If alpha = 1, than it must be Cauchy distribution
     */
    /* TODO: break the dependencies with Stat first
    @Test
