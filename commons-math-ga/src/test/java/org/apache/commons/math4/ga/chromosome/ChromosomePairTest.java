...
public class ChromosomePairTest {
    ...
    public void testChromosomePair() {
        BinaryChromosome<String> chromosome1 = new BinaryChromosome<>(
                ChromosomeRepresentationUtils.randomBinaryRepresentation(10), c -> 0,
                new DummyListChromosomeDecoder<>("0"));
        Chromosome<String> chromosome2 = new BinaryChromosome<>(
                ChromosomeRepresentationUtils.randomBinaryRepresentation(10), c -> 1,
