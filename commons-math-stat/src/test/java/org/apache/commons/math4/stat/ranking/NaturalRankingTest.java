...
import org.apache.commons.math4.stat.TestUtils;
import org.apache.commons.math4.utils.exception.NotANumberException;
...
public class NaturalRankingTest {
    ...
    public void testNaNsFixedTiesRandomDEBUG() {
        ...
        for (long i = start; i <= max; i++) {
            ...
            if (!org.apache.commons.math4.utils.MathArrays.equalsIncludingNaN(correctRanks, ranks)) continue;
