...
import org.apache.commons.math4.utils.exception.*;
...
* @see ChiSquareTest#chiSquare(double[], long[])
     ...
     * @see KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(ContinuousDistribution, double[])
     * @since 3.3
     */
     ...
     *         {@code distribution}
     * @see KolmogorovSmirnovTest#kolmogorovSmirnovTest(ContinuousDistribution, double[])
     * @since 3.3
     */
     ...
     * @return the p-value associated with the null hypothesis that {@code data} is a sample from
     *         {@code distribution}
     * @see KolmogorovSmirnovTest#kolmogorovSmirnovTest(ContinuousDistribution, double[], boolean)
     * @since 3.3
     */
     ...
     * @see KolmogorovSmirnovTest#kolmogorovSmirnovTest(ContinuousDistribution, double[], double)
     * @since 3.3
     */
     ...
     * greater than (resp. greater than or equal to) {@code d}
     * @see KolmogorovSmirnovTest#monteCarloP(double,int,int,boolean,int,UniformRandomProvider)
     * @since 3.3
     */
